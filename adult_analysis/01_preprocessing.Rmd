...
rt_path <- here("data/processed_data/trimmed_RTdata.csv")
prolific_path <- here("data/merged_data/prolific_demog.csv")
demog_path <- here("data/processed_data/trimmed_demogdata.csv")
similarity_path <- here("data/processed_data/trimmed_similaritydata.csv")
complexity_path <- here("data/processed_data/trimmed_complexitydata.csv")
