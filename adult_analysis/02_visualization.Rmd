...
ggplot(summarized, aes(x=trial_type, y=medianRT, colour=trial_type)) + geom_line() + geom_errorbar(aes(ymin=medianRT-SE, ymax=medianRT+SE),
                width=0.2, size = 0.8, position = position_dodge(width = 0.2), show.legend = FALSE, alpha = 0.8) +
...
## background vs deviant over time
```{r echo = FALSE}
