...
RAW_DATA_DIR <- here("data/00_raw_data/fs_only/")
MERGED_DATA_PATH <- here("data/01_merged_data/fs_only_merged_data.csv")


raw_files <- str_c(RAW_DATA_DIR, dir(here(RAW_DATA_DIR), "*.csv"))
