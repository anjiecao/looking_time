...
function generate_all_block(condition_num,
    ...
    [{'fam_duration':[2,2,6,4,6,4],'block_type':['background','deviant','deviant','background','background','deviant'],'block_number':[1,2,3,4,5,6],'counterbalancing_condition':[1,2,6,3,5,4]},
    {'fam_duration':[2,4,2,4,6,6],'block_type':['deviant','background','background','deviant','deviant','background'],'block_number':[1,2,3,4,5,6],'counterbalancing_condition':[2,3,1,4,6,5]},
    {'fam_duration':[4,4,2,6,2,6],'block_type':['background','deviant','deviant','background','background','deviant'],'block_number':[1,2,3,4,5,6],'counterbalancing_condition':[3,4,2,5,1,6]},
    {'fam_duration':[4,6,4,6,2,2],'block_type':['deviant','background','background','deviant','deviant','background'],'block_number':[1,2,3,4,5,6],'counterbalancing_condition':[4,5,3,6,2,1]},
    {'fam_duration':[6,6,4,2,4,2],'block_type':['background','deviant','deviant','background','background','deviant'],'block_number':[1,2,3,4,5,6],'counterbalancing_condition':[5,6,4,1,3,2]},
    {'fam_duration':[6,2,6,2,4,4],'block_type':['deviant','background','background','deviant','deviant','background'],'block_number':[1,2,3,4,5,6],'counterbalancing_condition':[6,1,5,2,4,3]}]
