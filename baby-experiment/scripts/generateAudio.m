...
startPoints = randi(length(x), [1 10]);
...
for i = 1:10
    ...
    % write files
    audiowrite(sprintf('/Users/galraz1/Developer/looking_time/baby-experiment/stimuli/audio/music_%d.wav', i), current_clip, Fs);
end
...
for i = 1:3
    ...
    % write files
    audiowrite(sprintf('/Users/galraz1/Developer/looking_time/baby-experiment/stimuli/audio/music_test_%d.wav', i), current_clip, Fs);
end