...
all_block_forced_trial = get_forced_trial(all_block_timeline_variables)
                    ...
                    timeline: [
                       ...
                       
                        {
                          ...
                          stimuli_animation: function(){
                                ...
                                console.log(jsPsych.timelineVariable('stimuli', true))
                                return html
                            },
                            ...
                            forced_viewing_duration: 10 * (getRandomInt(forced_short_viewing_duration_base, 100)), //50 ~ 1000 with 10 interval random
