...
jsPsych.plugins["stimuli-presentation"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      forced_viewing_duration:{
        type: jsPsych.plugins.parameterType.INT,
        pretty_name: 'forced viewing time duration',
        default: 0,
      ...
      exposure_type: {
          ...
          default: null,
         description: 'type of exposure: forced, self_paced'
      }, 
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.exposure_type == "forced"){ 
      
        var minimum_viewing_duration = trial.forced_viewing_duration
    ...
    var html_string = '<div id="stimuli-animation">' + trial.stimuli_animation + '</div>' + '<div id="background">'+ trial.frame_animation+'</div>';
    ...
    if (trial.exposure_type == "forced"){
        ...
        display_element.querySelector('#background').style.visibility = 'hidden'
    ...
    var end_trial = function() {
      ...
      var trial_data = {
        ...
        "forced_exposure_time": trial.forced_viewing_duration
      };
